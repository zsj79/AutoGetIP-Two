...
let addresses = [];
let addressesapi = ["https://rawaccess.pages.dev/zsj79/AutoGetIP/refs/heads/main/autoip.txt","https://rawaccess.pages.dev/zsj79/AutoGetIP/refs/heads/main/fixedip.txt"];
let addressesnotls = [];
...
let userIDLow;
let userIDTime = "";
let proxyIPPool = ["https://rawaccess.pages.dev/zsj79/AutoGetIP/refs/heads/main/proxyip.txt"];
let path = '/?ed=2560';
let 动态UUID;
let link = [];
